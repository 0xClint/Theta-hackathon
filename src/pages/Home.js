...
const Home = () => {
  return (
    <div className="ml-7 mr-10">
      <h2 className="font-normal text-[2rem] mb-2">Explore</h2>
      <div className="heroPoster flex gap-7">
        <div className="w-[60%] rounded-3xl bg-[#0DABBD]">
          <div className="left flex flex-col w-[50%] p-10 items-start gap-5">
            ...
            <div className="profileCard flex justify-center items-center gap-2">
              <div className="profileFrame w-[55px] h-[55px] rounded-full border-[1px] border-white flex justify-center items-center">
                ...
                <div className="absolute w-4 h-4 border-[3px] border-[#0DABBD] bg-white rounded-full translate-x-5 translate-y-5"></div>
              </div>
              <div>
